                ...
                <div class="container-fluid dashboard-inner-body-container">
                    <div class="breadcrumb-content d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="section-heading">
                            <h2 class="sec__title font-size-24 mb-0">My Profile</h2>
                        </div>
                            ...
                            <div class="block-card dashboard-card mb-4">
                                ...
                                <form action="{{ route('profile.update') }}" method="post" class="block-card-body"
                                    ...
                                    <div class="edit-profile-photo">
                                        <img src="{{ $user->image }}" alt="image-profile" class="profile-img">
                                        <div class="file-upload-wrap file-upload-wrap-2 ml-4 mt-2">
                                            <input type="file" name="image"
                                                class="multi file-upload-input with-preview" accept=".jpg, .jpeg, .png">
                                            <span class="file-upload-text"><i class="la la-photo mr-2"></i>Upload
                                                Photo</span>
                                        </div>
                                        @error('image')

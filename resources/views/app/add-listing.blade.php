            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="alert alert-info font-size-15 text-color" role="alert">
                        ...
                        and if you are a <span class="font-weight-semi-bold">New User, Continue Below</span> and
                        register along with this submission.
                    </div><!-- alert -->
                    <div class="block-card mb-4">
                        ...
                        <div class="block-card-body">
                            <form method="post" class="form-box row">
                                <div class="col-lg-12">
                                    <div class="input-box">
                                        <label class="label-text">Your Email <span
                                ...
                                <div class="col-lg-6">
                                    <div class="input-box">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="font-size-12 font-weight-medium">Passwords must be at least 8
                                ...
                                <div class="col-lg-6">
                                    <div class="input-box">
                                        <label class="label-text">Verify Password <span
                                                class="text-gray font-size-12">(optional)</span></label>
                                        <div class="form-group">
                                            <span class="la la-lock form-icon"></span>
                                            <input class="form-control" type="text" name="text"
                                ...
                                <div class="col-lg-12">
                                    <div class="input-box">
                                        <label class="label-text d-flex align-items-center">Keywords or Tags
                                            <i class="la la-question tip ml-1" data-toggle="tooltip"
                                                data-placement="top"
                                                title="These keywords or tags will help your listing to find in search.Maximum of 3 keywords related with your business"></i>
                                        </label>
                                        <div class="form-group user-chosen-select-container">
                    ...
                    <div class="block-card mb-4">
                        ...
                        <div class="block-card-body">
                            <form method="post" class="form-box row">
                                ...
                                <div class="col-lg-12">
                                    <div class="input-box">
                                        <label class="label-text">For precise location, drag the red marker on the
                                            map.</label>
                                        <div class="form-group map-container">
                                            <div id="singleMap" class="drag-map height-400"
                                                data-latitude="40.7427837" data-longitude="-73.11445617675781"></div>
                                        </div>
                                    </div>
                                </div><!-- end col-lg-12 -->
                                <div class="col-lg-12">
                                                ...
                                                <select class="user-chosen-select">
                                                    ...
                                                    <optgroup label="America">
                                                        ...
                                                        <option value="America/Argentina/Catamarca">Argentina -
                                                            Catamarca</option>
                                                        <option value="America/Argentina/Cordoba">Argentina - Cordoba
                                                        </option>
                                                        <option value="America/Argentina/Jujuy">Argentina - Jujuy
                                                        </option>
                                                        <option value="America/Argentina/La_Rioja">Argentina - La
                                                            Rioja</option>
                                                        <option value="America/Argentina/Mendoza">Argentina - Mendoza
                                                        </option>
                                                        <option value="America/Argentina/Rio_Gallegos">Argentina - Rio
                                                            Gallegos</option>
                                                        ...
                                                        <option value="America/Argentina/San_Luis">Argentina - San
                                                            Luis</option>
                                                        <option value="America/Argentina/Tucuman">Argentina - Tucuman
                                                        </option>
                                                        <option value="America/Argentina/Ushuaia">Argentina - Ushuaia
                                                        </option>
                                                        ...
                                                        <option value="America/Indiana/Petersburg">Indiana -
                                                            Petersburg</option>
                                                        <option value="America/Indiana/Tell_City">Indiana - Tell City
                                                        </option>
                                                        <option value="America/Indiana/Vevay">Indiana - Vevay</option>
                                                        <option value="America/Indiana/Vincennes">Indiana - Vincennes
                                                        </option>
                    ...
                    <div class="block-card mb-4">
                        ...
                        <div class="block-card-body">
                            <form method="post" class="form-box row">
                                ...
                                <div class="col-lg-12">
                                    <div class="input-box">
                                        <label class="label-text">Video <span
                                                class="text-gray font-size-12">(optional)</span></label>
                                        <div class="form-group mb-0">
                                            <span class="la la-video form-icon"></span>
                                            <input class="form-control" type="text" name="text"
                                                placeholder="URL to video">
                                            <span class="font-size-12 font-weight-medium">Display a video on your
                                                Listing</span>
                                        </div>
                                    </div>
                                </div><!-- end col-lg-12 -->
                    ...
                    <div class="block-card mb-4">
                        ...
                        <div class="block-card-body">
                            ...
                            <div class="file-upload-wrap">
                                <input type="file" name="files[]" class="multi file-upload-input with-preview"
                                    multiple>
                    ...
                    <div class="block-card mb-4">
                        ...
                        <div class="block-card-body">
                            <form method="post" class="form-box row">
                                ...
                                <div class="col-lg-12">
                                    <div class="btn-box">
                                        <button type="button" class="theme-btn gradient-btn border-0">Create
                                            FAQ</button>
                                    </div>
                                </div><!-- end col-lg-12 -->
                            </form>

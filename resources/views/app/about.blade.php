<x-app-layout>
    ...
    {{--  BREADCRUMB AREA --}}
    <section class="breadcrumb-area breadcrumb--area bread-bg-2 bread-overlay overflow-hidden">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 responsive-column">
                    <a href="career.html" class="card-item card-item-layout-2 d-block hover-scale-2">
                        <div class="card-image">
                            <img src="images/img-loading.html" data-src="images/img31.jpg" class="card__img lazy"
                                alt="blog image">
                        </div><!-- end card-image -->
                        <div class="card-content">
                            <h4 class="card-title">careers</h4>
                            <p class="card-sub mt-3">Ut euismod ultricies sollicitudin. Curabitur sed dapibus nulla.
                                Nulla eget iaculis.</p>
                        </div><!-- end card-content -->
                    </a><!-- end card-item -->
                </div><!-- end col-lg-4 -->
                <div class="col-lg-4 responsive-column">
                    <a href="blog-grid.html" class="card-item card-item-layout-2 d-block hover-scale-2">
                        <div class="card-image">
                            <img src="images/img-loading.html" data-src="images/img32.jpg" class="card__img lazy"
                                alt="blog image">
                        </div><!-- end card-image -->
                        <div class="card-content">
                ...
                <div class="col-lg-4 responsive-column">
                    <a href="#" class="card-item card-item-layout-2 d-block hover-scale-2">
                        <div class="card-image">
                            <img src="images/img-loading.html" data-src="images/img33.jpg" class="card__img lazy"
                                alt="blog image">
                        </div><!-- end card-image -->
                        <div class="card-content">
                ...
                <div class="col-lg-6">
                    <div class="about-content mt-0">
                        <div class="section-heading">
                            ...
                            <h2 class="sec__title">Welcome to the Listhub Business Directory Service and a Public
                                Company</h2>
                        ...
                        <div class="btn-box padding-top-30px">
                            <a href="#" class="theme-btn gradient-btn">Find out More<i
                    ...
                    <div class="img-boxes row">
                        <div class="col-lg-6 responsive-column">
                            <div class="img-box-item mb-4 js-tilt-2">
                                <img class="lazy" src="images/img-loading.html" data-src="images/img20.jpg"
                                    alt="about-img">
                            </div>
                            <div class="img-box-item js-tilt-2">
                                <img class="lazy" src="images/img-loading.html" data-src="images/img21.jpg"
                                    alt="about-img">
                            </div>
                        </div>
                        <div class="col-lg-6 responsive-column">
                            <div class="img-box-item js-tilt-2">
                                <img class="lazy" src="images/img-loading.html" data-src="images/img38.jpg"
                                    alt="about-img">
                            </div>
                        </div>
                    </div><!-- end img-boxes -->
                ...
                <div class="col-lg-6">
                    <div class="img-boxes">
                        <div class="img-box-item">
                            <img class="lazy" src="images/img-loading.html" data-src="images/img31.jpg"
                                alt="about-img">
                        </div>
                    </div><!-- end img-boxes -->
                </div><!-- end col-lg-6 -->
                <div class="col-lg-6">
                    <div class="about-content pl-4 mb-0">
                        <div class="section-heading">
                            ...
                            <p class="sec__desc pb-3">
                                An online marketplace (or online e-commerce marketplace) is a type of e-commerce site
                                where product and inventory information is provided by multiple third parties, whereas
                    ...
                    <div class="about-content text-center">
                        <div class="section-heading">
                            ...
                            <p class="sec__desc">
                                ...
                                solutions without functional solutions. Completely synergize resource sucking
                                relationships via premier niche markets. Professionally cultivate one-to-one customer
                                service with robust ideas. Dynamically innovate resource-leveling customer service for
                                state of the art customer service. Objectively innovate empowered manufactured products
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="counter-item d-flex align-items-center">
                        <div class="counter-icon section-icon flex-shrink-0 bg-opacity-1">
                            <svg class="svg-icon-color" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                x="0px" y="0px" viewBox="0 0 438.891 438.891" xml:space="preserve">
                                <g>
                                    <path
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="counter-item d-flex align-items-center">
                        <div class="counter-icon section-icon flex-shrink-0 bg-opacity-2">
                            <svg class="svg-icon-color-2" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="row padding-top-60px">
                <div class="col-lg-4 responsive-column">
                    <div class="info-box info--box js-tilt-2">
                        <div class="info-icon gradient-icon">
                            <svg width="40" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px"
                                y="0px" viewBox="0 0 505.4 505.4" xml:space="preserve">
                                <defs>
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="info-box info--box js-tilt-2">
                        <div class="info-icon gradient-icon">
                            <svg width="40" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px"
                                y="0px" viewBox="0 0 496 496" xml:space="preserve">
                                <defs>
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="info-box info--box js-tilt-2">
                        <div class="info-icon gradient-icon">
                            <svg id="_x31_" viewBox="0 0 24 24" width="40"
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="btn-box pt-4">
                        <a href="#login" class="theme-btn gradient-btn hover-scale" data-toggle="modal"
                            data-target="#signUpModal">Create Your Business Listing Today <i
                                class="la la-arrow-right ml-2"></i></a>
                    </div><!-- end btn-box -->
                </div><!-- end col-lg-12 -->
            </div><!-- end row -->

!(function (e) {
    ...
    a.on("load", function () {
        var t = e(document),
            ...
            s = e(".main-menu-content .dropdown-menu-item"),
            i = e(".user-chosen-select"),
            l = e(".counter"),
            r = e(".user-text-editor"),
            c = e("#back-to-top"),
            d = e(".card-carousel"),
            p = e(".card-carousel-2"),
            m = e(".card-carousel-3"),
            h = e(".client-logo"),
            u = e(".testimonial-carousel"),
            g = e(".gallery-carousel"),
            v = e(".date-dropper-input"),
            f = e(".full-screen-slider"),
            w = e(".online-user-slider"),
            y = e(".emoji-picker"),
            b = e("#sticky-content-nav .scroll-link"),
            C = e(".single-slider"),
            k = e(".js-tilt"),
            x = e(".js-tilt-2"),
            T = e(".lazy");
        function S(a) {
            e(a).each(function () {
                ...
                a >= 4
                    ? (e(this).addClass("high"),
                      e(this)
                          .find(".review-bars-review-inner")
                          .css({ width: (a / 5) * 100 + "%" }))
                    : a >= 3
                    ? (e(this).addClass("mid"),
                      e(this)
        ...
        o.delay("500").fadeOut(2e3),
            t.on("click", "#sidebarToggleTop", function () {
            ...
            e(g).length &&
                e(g).owlCarousel({
                    ...
                    navText: [
                        ...
                        '<span class="la la-chevron-right"></span>',
                    ],
                }),
            e(v).length && e(v).dateDropper(),
            e(f).length &&
                e(f).owlCarousel({
                    loop: !1,
                    items: 4,
            ...
            e(".qtyDec, .qtyInc").on("click", function () {
                var a = e(this),
                    t = a.parent().find('input[type="text"]').val();
                if (a.hasClass("qtyInc")) var n = parseFloat(t) + 1;
            ...
            e(i).on("chosen:showing_dropdown", function (a, t) {
                var n = e(a.target).next(".chosen-container"),
                    o = n.find(".chosen-drop");
                o.offset().top - e(window).scrollTop() + o.height() >
                    e(window).height() && n.addClass("chosen-drop-up");
            }),
            e(i).on("chosen:hiding_dropdown", function (a, t) {
                e(a.target)
                    .next(".chosen-container")
                    .removeClass("chosen-drop-up");
            }),
            e(l).length && e(l).counterUp({ delay: 10, time: 1e3 }),
            e(r).length &&
                e(r).jqte({
            ...
            e(k).length && e(k).tilt({ maxTilt: 1 }),
            e(x).length && e(x).tilt({ maxTilt: 4 }),
            e("[data-fancybox]").fancybox(),
            e(y).length && e(y).emojioneArea({ pickerPosition: "top" }),
            ...
            t.on("click", ".bookmark-btn", function () {
                e(this).toggleClass("active");
            }),
            t.on("click", ".login-btn", function () {
                e(".login-form").modal("show"),
                    e(".signup-form, .message-form").modal("hide");
            }),
            t.on("click", ".signup-btn", function () {
                e(".login-form, .recover-form").modal("hide"),
                    e(".signup-form").modal("show");
            }),
            t.on("click", ".lost-pass-btn", function () {
                e(".login-form").modal("hide"),
                    e(".recover-form").modal("show");
            }),
            e("#map").length &&
        ...
        for (
            var j = document.querySelectorAll(".payment-tab-toggle > input"),
                q = 0;
            q < j.length;
            q++
        )
            j[q].addEventListener("change", D);
        function D(e) {
            for (
                var a = document.querySelectorAll(".payment-tab"), t = 0;
                t < a.length;
                t++
            )
        ...
        b.on("click", function (a) {
            ...
            e(n).animate({ scrollTop: t.offset().top }, 600),
...
badges.forEach((badge) => {
    badge.addEventListener("click", function () {
        if (this.classList.contains("check-active")) {
            this.classList.remove("check-active");
        } else {
            this.classList.add("check-active");
        }
    });
});
